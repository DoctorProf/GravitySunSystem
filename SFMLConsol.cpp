    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == Event::KeyReleased && event.key.code == Keyboard::Num1) {
                ...
                spawnPlanet(5, 3.33e23, Vector2f(0, 7), Vector2f(sun.getPosition().x + 29, sun.getPosition().y), std::ref(circleVec), std::ref(velocities),
                ...
                spawnPlanet(5, 1.89e27, Vector2f(0, 2), Vector2f(sun.getPosition().x + 389, sun.getPosition().y), std::ref(circleVec), std::ref(velocities),
                    std::ref(positions), std::ref(masses), std::ref(radiuses), std::ref(circleTrack), Color::Color(255, 226, 183));

                spawnPlanet(5, 5.68e26, Vector2f(0, 1.5), Vector2f(sun.getPosition().x + 700, sun.getPosition().y), std::ref(circleVec), std::ref(velocities),
                    std::ref(positions), std::ref(masses), std::ref(radiuses), std::ref(circleTrack), Color::Color(255, 219, 139));

                spawnPlanet(5, 8.68e25, Vector2f(0, 1.1), Vector2f(sun.getPosition().x + 1400, sun.getPosition().y), std::ref(circleVec), std::ref(velocities),
