...
void gl::generateButton(std::vector<Planet>& planets, std::vector<Button>& buttonsPlanet, std::vector<Button>& buttonsLogic, std::vector<Button>& buttonsInfo, RenderWindow& window)
{
    for (int i = 0; i < planets.size(); i++)
    {
